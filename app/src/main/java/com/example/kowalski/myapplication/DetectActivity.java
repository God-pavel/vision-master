...
//            Imgproc.cvtColor(img2, img2, Imgproc.COLOR_HSV2RGB);
            ...
            double res = Imgproc.compareHist(hist, hist2, Imgproc.CV_COMP_CORREL);
            // If face passes histogram check, draw a rectangle around it
            if (res > minHistPercentage) {
                Intent i = new Intent(this, ResultActivity.class);
                i.putExtra("banknote", name);
                startActivity(i);
                Core.putText(aInputFrame, name+' '+res, new Point(rect.x + 5, rect.y + 30), Core.FONT_HERSHEY_COMPLEX, 2, new Scalar(0, 255, 0, 255), 3);
                Core.rectangle(aInputFrame, rect.tl(), rect.br(), new Scalar(0, 255, 0, 255), 3);
            } else {
                Core.putText(aInputFrame, name+' '+res, new Point(rect.x + 5, rect.y + 30), Core.FONT_HERSHEY_COMPLEX, 2, new Scalar(255, 0, 0, 255), 3);
